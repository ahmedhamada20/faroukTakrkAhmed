...
class newsletterController extends Controller
{
    protected $data = [
        'folder' => 'backend.',
        'Models' => 'App\Models\Newsletter',
        'route' => 'admin/newsletter',
        'folderBlade' => 'newsletter',
        'folderImage' => 'member',
        'fileName' => 'test'
    ];
    ...
    public function member_remove_image(Request $request)
    {
        $photo = Photo::findorfail($request->photo_id);
        if (File::exists('admin/pictures/member/' . $request->data_id . '/' . $photo->Filename)) {
