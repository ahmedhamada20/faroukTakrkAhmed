...
class OurClientController extends Controller
{
    protected $data = [
        'folder' => 'backend.',
        'Models' => 'App\Models\OurClient',
        'route' => 'admin/qurClient',
        'folderBlade' => 'qurClient',
        'folderImage' => 'qurClient',
        'fileName' => 'test'
    ];
    ...
    public function qurClient_remove_image(Request $request)
    {
        $photo = Photo::findorfail($request->photo_id);
        if (File::exists('admin/pictures/qurClient/' . $request->data_id . '/' . $photo->Filename)) {
